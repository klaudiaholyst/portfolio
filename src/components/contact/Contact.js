    ...
    return (
        <main className={styles.contact}>
            ...
            <div className={styles.container}>
                <a href="mailto:klaudia.holyst@gmail.com"><img src={mail} className={styles.icon} alt="mail"/></a>
                <a href="mailto:klaudia.holyst@gmail.com" className={styles.link}>klaudia.holyst@gmail.com</a>
